...
export const RegistrationInputs:React.FC<Props> = ({formState, setFormState}) => {
        ...
        <>
            <Row name="email">
                ...
                <Row name="repeatPassword">
                    ...
                    <RepeatPassValidate className={repeatPasswordValid || !formState.repeatPassword ? '' : 'validateText'}>
                        Пароли не совпадают
                    </RepeatPassValidate>
                </Row>
        </>
