export const CHANGE_PASSWORD_URL = 'https://marathon-api.clevertec.ru/auth/change-password';
export const CONFIRM_EMAIL_URL = 'https://marathon-api.clevertec.ru/auth/confirm-email';
